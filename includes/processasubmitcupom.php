...
if(!empty($inputCupom['submitcupomconfirm'])):
    ...
    else if ($inputCupom['type_discount'] == 2) {
    	if($inputCupom['fixed_value'] == ''):
    		(int) $inputCupom['fixed_value'] = 1.00;
    	elseif((int) $inputCupom['fixed_value'] < 1):
    		$inputCupom['fixed_value'] = 1.00;
    	else: 
    		$inputCupom['fixed_value'] = str_replace(',', '.', $inputCupom['fixed_value']);
    		$inputCupom['fixed_value'] = strpos($inputCupom['fixed_value'],".") === false ? number_format($inputCupom['fixed_value'],2,'.','') : $inputCupom['fixed_value'];
    		$inputCupom['fixed_value'] = $inputCupom['fixed_value'];    
    	endif;
    }
