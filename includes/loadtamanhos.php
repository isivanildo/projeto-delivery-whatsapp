										...
										<form id="formeditartamanho_<?=$id_option;?>" style="margin-top: 10px;" method="post">
											<div>
												<div class="form-group">
													...
													<label for="edit_valor_tamanho">VALOR R$ <small style="color: red;">*</small></label>
													<input required
													type="text" 
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.editarotamanho').click(function(){
			...
			}else if($("#edit_valor_tamanho").val() == '0,00'){
				$('#resultadoformeditoption').html('<br /><b style="color:red;">O campo valor não pode ser 0,00!</b>');
				setTimeout(function () {
					$('#resultadoformeditoption').html('');
				}, 3000);
			}else{
