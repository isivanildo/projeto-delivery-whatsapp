								...
								<form id="formaddoptiontamanho" style="margin-top: 10px;" method="post">
									<div>
										<div class="form-group">
											...
											<label for="valor_tamanho">VALOR R$ <small style="color: red;">*</small></label>
											<input required
											type="text" 
											name="valor_tamanho" 
											id="valor_tamanho" 
											...
											<div id="opcao" style="visibility: hidden;">
												...
												<div class="icheck-material-green">
													<input type="radio" id="meioameiotres" required value="3" name="meio_a_meio_tipo" />
				...
				$(document).ready(function(){
					$('#submitoption').click(function(){					
						...
						if($("#nome_option").val() == '' || $("#valor_tamanho").val() == '' || $("#id_tipo").val() == ''){
							...
							$(this).html('Cadastrar');
						}else if($("#meioameiodois").prop("checked") && $("#valor_tamanho").val() == '0,00'){
							$('#resultadoformaddoption').html('<br /><b style="color:red;">O campo valor não pode ser 0,00</b>');
							setTimeout(function () {
								$('#resultadoformaddoption').html('');
							}, 3000);
							$(this).html('Cadastrar');
