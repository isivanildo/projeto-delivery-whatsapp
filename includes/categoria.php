...
<div style="background-color:#ffffff;" class="container margin_60">
 <div class="row"> 
  ...
  $capturacat['desc_cat'] = strip_tags(trim($capturacat['desc_cat']));
  $capturacat['nome_cat'] = strip_tags(trim($capturacat['nome_cat']));
  $capturacat['dias_semana'] = (!empty($capturacat['dias_semana']) ? implode(",", $capturacat['dias_semana'])  : "null");
