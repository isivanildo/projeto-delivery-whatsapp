						...
						<div class="box_style_2" id="order_process">				
							...
							<?php if($_POST['opcao_delivery'] == 'true'):?>	
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											<label for="numero"><span style="color: red;">* </span><?=$texto['msg_seu_n'];?></label>
											<input type="tel" required id="numero" data-mask="#########0" name="numero" size="60" class="form-control" placeholder="">
										</div>
									</div>
