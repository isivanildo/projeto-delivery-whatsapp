					...
					<ul>
						...
						<?php if(!empty($_SESSION['userlogin'])):?>							
							...
							<li class="submenu">
								...
								<ul>
									<li><a href="<?=$site.$Url[0].'/';?>qrcodeurl">QR code & compartilhamento</a></li>
									<li><a href="<?=$site.$Url[0].'/';?>banner-promocao">Banner Promocional</a></li>
									...
									<li><a href="<?=$site.$Url[0].'/';?>add-adicionais-gratis"><?=$texto['cadastros-complementos-gratis'];?></a></li>
									<li><a href="<?=$site.$Url[0].'/';?>add-adicionais-categoria"><?=$texto['cadastros-complementos-categoria'];?> <span class="badge" style="background-color: #dc3545; color: #ffffff;">Novo</span></a></li>
									<li><a href="<?=$site.$Url[0].'/';?>add-complemento-unico"><?=$texto['cadastros-opcao'];?></a></li>
...
<div id="position" style="display: none;">
	<div class="container">
		...
		😍	<b style="color: red;">Bem-vindo(a)! Obrigado pela preferência...</b>
...
if($lerbanco->getResult()):
	...
	elseif(!empty($_SESSION['desconto_cupom'])):
		...
		if(!$updatebanco->getResult()): 
			...
			$_SESSION['desconto_cupom']['desconto'] = $getdbcupom[0]['type_discount'] == 1 ? $getdbcupom[0]['porcentagem'] : $getdbcupom[0]['fixed_value'];
			$_SESSION['desconto_cupom']['type_discount'] = $getdbcupom[0]['type_discount'];
